...
const start = async () => {
  ...
  [{"name": "YCABAL-FR-WS", "url": process.env.YCABAL_FR_WS_PROVIDER_URL},
  {"name": "YCABAL-WS", "url": process.env.YCABAL_WS_PROVIDER_URL},
  ...
  // JSON RPC providers
  while (true) {
    [{"name": "YCABAL-FR", "url": process.env.YCABAL_FR_PROVIDER_URL},
    {"name": "YCABAL", "url": process.env.YCABAL_PROVIDER_URL},
